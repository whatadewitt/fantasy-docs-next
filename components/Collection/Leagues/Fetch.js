              ...
              {activeTab === "tester" && (
                <div>
                  <input
                    ...
                    type="checkbox"
                    onChange={(e) => updateSubresources("settings")}
                  ></input>
                </div>
              )}
              <div>Retrieve the settings for the retrieved leagues.</div>
            </div>
            <div className={appStyles.row}>
              <div className={cx(appStyles.arg, appStyles.subresource)}>
                standings
              ...
              <div>Retrieve the standings for the retrieved leagues.</div>
            </div>
            <div className={appStyles.row}>
              <div className={cx(appStyles.arg, appStyles.subresource)}>
                scoreboard
              ...
              {activeTab === "tester" && (
                <div>
                  <input
                    className={appStyles.value}
                    type="checkbox"
                    onChange={(e) => updateSubresources("scoreboard")}
                  ></input>
                </div>
              )}
              <div>Retrieve the scoreboards for the retrieved leagues.</div>
            </div>
            <div className={appStyles.row}>
              <div className={cx(appStyles.arg, appStyles.subresource)}>
                teams
              ...
              {activeTab === "tester" && (
                <div>
                  <input
                    className={appStyles.value}
                    type="checkbox"
                    onChange={(e) => updateSubresources("teams")}
                  ></input>
                </div>
              )}
              <div>Retrieve the teams for the retrieved leagues.</div>
            </div>
            <div className={appStyles.row}>
              <div className={cx(appStyles.arg, appStyles.subresource)}>
                draftresults
              ...
              <div>
                Retrieve the draftresults for the retrieved leagues.{" "}
                <em>
              ...
              {activeTab === "tester" && (
                <div>
                  <input
                    className={appStyles.value}
                    type="checkbox"
                    onChange={(e) => updateSubresources("transactions")}
                  ></input>
                </div>
              )}
              <div>Retrieve the transactions for the retrieved leagues.</div>
            </div>
          </div>
...
// promise based
try {
  const leagues = await yf.leagues.fetch(
    [league_keys],
