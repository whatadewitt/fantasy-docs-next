...
const Game = () => (
  <>
    <div>
      <h2>Games</h2>
      <p>
        With the Games Collection API, you can obtain the fantasy game related
        information, like the fantasy game name, the Yahoo! game code, and
        season from multiple games at the same time.
      </p>
      <p>
      ...
      <div className={appStyles.table}>
        ...
        <div className={appStyles.row}>
          <div>
            <Link href="/collection/games/fetch">games.fetch</Link>
          </div>
          <div>Retrieve information about multiple games at once</div>
        </div>
        <div className={appStyles.row}>
          <div>
            <Link href="/collection/games/user">games.user</Link>
          </div>
          <div>
            Retrieve information about games played by the currently logged in
            user
          </div>
        </div>
      </div>
